use crate::MAX_INSTRUCTION_TRACE_LENGTH;
...
pub const MAXIMUM_VALID_ADDRESS: u64 = GUEST_INSTRUCTION_ACCOUNT_BASE_ADDRESS
    + MAX_INSTRUCTION_TRACE_LENGTH as u64 * GUEST_REGION_SIZE;
