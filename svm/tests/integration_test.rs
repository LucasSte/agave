...
fn prepare_transactions(
    ...
    let sanitized_transaction =
        transaction_builder.build(Hash::default(), Some((fee_payer, Signature::new_unique())), false);
    ...
    let sanitized_transaction =
        transaction_builder.build(Hash::default(), Some((fee_payer, Signature::new_unique())), true);
    all_transactions.push(sanitized_transaction);
    transaction_checks.push((Ok(()), None, Some(20)));
